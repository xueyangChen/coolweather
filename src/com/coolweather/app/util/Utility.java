...
public class Utility {
	...
	/*
	 * 将服务器返回的JSON数据解析，并将解析出来得数据存储在本地
	 */
	public static void handleWeatherResponse(Context context,String response){
		try{
			...
			String temp1 = weatherInfo.getString("temp_high");
			String temp2 = weatherInfo.getString("temp_low");
			String weatherDesp = weatherInfo.getString("weather");
			String currentDate = weatherInfo.getString("days");
			String publishTime = weatherInfo.getString("week");
			saveWeatherInfo(context,cityName,weatherCode,temp1,temp2,weatherDesp,publishTime,currentDate);
	...
	private static void saveWeatherInfo(Context context, String cityName, String weatherCode, String temp1,
			String temp2, String weatherDesp,String publishTime,String currentDate) {
